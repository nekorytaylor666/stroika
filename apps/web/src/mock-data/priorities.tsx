...
export const priorities: Priority[] = [
   { id: 'no-priority', name: 'Без приоритета', icon: NoPriorityIcon },
   { id: 'urgent', name: 'Срочный', icon: UrgentPriorityIcon },
   { id: 'high', name: 'Высокий', icon: HighPriorityIcon },
   { id: 'medium', name: 'Средний', icon: MediumPriorityIcon },
   { id: 'low', name: 'Низкий', icon: LowPriorityIcon },
];
