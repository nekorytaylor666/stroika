...
export const status: Status[] = [
   { id: 'in-progress', name: 'В работе', color: '#facc15', icon: InProgressIcon },
   {
      id: 'technical-review',
   ...
   { id: 'completed', name: 'Завершено', color: '#8b5cf6', icon: CompletedIcon },
   { id: 'paused', name: 'Приостановлено', color: '#0ea5e9', icon: PausedIcon },
   { id: 'to-do', name: 'К выполнению', color: '#f97316', icon: ToDoIcon },
   { id: 'backlog', name: 'Бэклог', color: '#ec4899', icon: BacklogIcon },
];
