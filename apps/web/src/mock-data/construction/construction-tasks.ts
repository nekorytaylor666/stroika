...
export const constructionTasks: Issue[] = [
	{
		...
		description:
			"Необходимо проверить качество заливки фундамента для многофункционального жилого комплекса",
	...
	},
	{
		...
		description:
			'Требуется согласовать план прокладки электрических распределительных сетей с ТОО "Invest Jp"',
	...
	},
	{
		...
		description:
			"Организовать закупку строительных материалов для финишных работ в торговом центре New Life",
	...
	},
	{
		...
		description:
			"Провести инспекцию безопасности строительства АНПС в городах Тараз и Алматы",
	...
	},
	{
		...
		description:
			"Координация установки специализированного медицинского оборудования в реабилитационном центре",
	...
	},
	{
		...
		description:
			"Разработка и реализация ландшафтного дизайна для коттеджной зоны Достак",
		status: status[1], // In Progress
		assignee: users[5],
	...
	},
	{
		...
		description:
			"Провести финальную приемку фундаментных решений БСК и подготовить документацию",
...
export function groupConstructionTasksByStatus(
	tasks: Issue[],
): Record<string, Issue[]> {
	return tasks.reduce(
		(acc, task) => {
