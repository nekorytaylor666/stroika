import { type ConstructionProject, constructionProjects } from './construction-projects';
...
export const constructionTeams: ConstructionTeam[] = [
    ...
    },
    {
        ...
        projects: [constructionProjects[0], constructionProjects[2], constructionProjects[6]],
    ...
    },
    {
        ...
        projects: [constructionProjects[0], constructionProjects[2], constructionProjects[5]],
        department: 'design',
        workload: 78,
    },
    {
    ...
    },
    {
        ...
        projects: [constructionProjects[1], constructionProjects[3], constructionProjects[4]],
        department: 'engineering',
        workload: 88,
    },
    {
    ...
    },
    {
        ...
        projects: [constructionProjects[0], constructionProjects[2], constructionProjects[4]],
        department: 'management',
        workload: 67,
    },
    {
...
// Utility functions
export function getTeamsByDepartment(department: ConstructionTeam['department']): ConstructionTeam[] {
