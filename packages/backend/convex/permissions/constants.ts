...
export const ORGANIZATIONAL_POSITIONS = {
  ...
  CHIEF_ENGINEER: { name: "chief_engineer", displayName: "Главный инженер проекта (ГИП)", level: 2 },
  DEPARTMENT_HEAD: { name: "department_head", displayName: "Руководитель отдела", level: 3 },
  SENIOR_SPECIALIST: { name: "senior_specialist", displayName: "Старший специалист", level: 4 },
...
export const ROLE_DESCRIPTIONS: Record<string, string> = {
  ...
  [SYSTEM_ROLES.CHIEF_ENGINEER]: "Главный инженер проекта, управление всеми техническими аспектами",
  [SYSTEM_ROLES.DEPARTMENT_HEAD]: "Руководитель отдела, управление сотрудниками и проектами отдела",
  [SYSTEM_ROLES.PROJECT_MANAGER]: "Управление проектами, командами и назначение задач",
...
export const ALL_PERMISSIONS: Array<{
  ...
  { resource: "constructionProjects", action: "create", description: "Create construction projects" },
  { resource: "constructionProjects", action: "read", description: "View construction projects" },
  { resource: "constructionProjects", action: "update", description: "Update construction projects" },
  { resource: "constructionProjects", action: "delete", description: "Delete construction projects" },
  { resource: "constructionProjects", action: "manage", description: "Manage construction projects" },
  ...
  { resource: "constructionTeams", action: "create", description: "Create construction teams" },
  { resource: "constructionTeams", action: "read", description: "View construction teams" },
  { resource: "constructionTeams", action: "update", description: "Update construction teams" },
  { resource: "constructionTeams", action: "delete", description: "Delete construction teams" },
  { resource: "constructionTeams", action: "manage", description: "Manage construction teams" },

  // Issue/Task permissions
  { resource: "issues", action: "create", description: "Create new issues/tasks" },
  ...
  { resource: "issues", action: "manage", description: "Full issue management" },
  ...
  // Revenue permissions
  { resource: "revenue", action: "create", description: "Create revenue entries" },
  { resource: "revenue", action: "read", description: "View revenue data" },
  { resource: "revenue", action: "update", description: "Update revenue data" },
  { resource: "revenue", action: "delete", description: "Delete revenue entries" },
  { resource: "revenue", action: "manage", description: "Full revenue management" },

  // Work Category permissions
  { resource: "workCategories", action: "create", description: "Create work categories" },
  { resource: "workCategories", action: "read", description: "View work categories" },
  { resource: "workCategories", action: "update", description: "Update work categories" },
  { resource: "workCategories", action: "delete", description: "Delete work categories" },
  { resource: "workCategories", action: "manage", description: "Manage work categories" },
];

// Default permissions for each role
export const DEFAULT_ROLE_PERMISSIONS: Record<string, Array<{ resource: PermissionResource; action: PermissionAction }>> = {
  [SYSTEM_ROLES.OWNER]: ALL_PERMISSIONS.map(p => ({ resource: p.resource, action: p.action })),
  
  [SYSTEM_ROLES.CEO]: ALL_PERMISSIONS.map(p => ({ resource: p.resource, action: p.action })),
  
  [SYSTEM_ROLES.CHIEF_ENGINEER]: ALL_PERMISSIONS.filter(p => 
