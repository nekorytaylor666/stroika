    ...
    handler: async (ctx) => {
        ...
        const users = [
            ...
            },
            {
                ...
                avatarUrl: "https://images.unsplash.com/photo-1494790108755-2616b1f2ce86?w=40&h=40&fit=crop&crop=face",
                status: "online" as const,
                role: "Архитектор",
        ...
        const projectIds = await Promise.all(
            constructionProjects.map(project => ctx.db.insert("constructionProjects", project))
        );
        ...
        const constructionTasks = [
            ...
            },
            {
                ...
                description: "Создать проект ландшафтного дизайна для прилегающей территории",
                statusId: statusIds[1], // В работе
            ...
            },
            {
                ...
                description: "Подготовка к сдаче объекта заказчику и получение акта приемки",
                statusId: statusIds[0], // К выполнению
                assigneeId: userIds[3],
                priorityId: priorityIds[0], // Критический
